...
let videoStream = null; // Menyimpan stream aktif
...
function flipCamera() {
    ...
    // Ganti kamera antara "user" dan "environment"
...
function checkIfMobile() {
    if (/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)) {
        document.getElementById("flip-camera-btn").classList.remove("d-none"); // Tampilkan tombol flip
    }
}
...
document.addEventListener("DOMContentLoaded", function () {
    checkIfMobile();
    startCamera(); // Default kamera depan
});
